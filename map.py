...
location_entry_exit = {
    ...
    "description":
    "The entrance to the bank. Several security cameras overhang the steel impact-resistant doors.One unarmed security "
    "guards are patrolling the entrance.",
...
location_consultation = {
    ...
    "description":
    "Consultation booths are scattered around the room. It would appear that all employees are pre-occupied with"
    " customers,a single security camera watches from the south-east corner of the room.",
...
location_managers = {
    ...
    "description":
    "The Manager of the bank resides here from 9:00 to 19:00. The manager keeps a close eye on security and is "
    "constantly on high alert. The Office itself is locked, entry is only permitted by using the intercom and "
    "requesting entry from the manager himself.",
...
location_security = {
    ...
    "description":
    "All activity within the bank is monitored from this station. The office is operated by several security officers,"
...
location_vault = {
    ...
    "description":
    "All of the banks valuables are stored here. Security cameras are located on each corner of the room. The vault"
    " itself is made of a special concrete with a steel cladding, reinforced with a network of steel rods. The vault "
    "is secured electronically with two key card scanners, as well as a combination lock. You notice that the locks"
    " are alarmed, and will most likely be set off after a single failed attempt of entry.",


    "exits": {"north":"Bank Tellers"},
...
location_janitor = {
    ...
    "contents": ["broom", "paper", "janitorsuniform", "vent","cutters"],
